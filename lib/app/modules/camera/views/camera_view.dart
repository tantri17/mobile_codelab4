      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            ...
            children: [
              // UI untuk menampilkan, memilih, dan mendapatkan foto menggunakan kamera atau galeri
              SizedBox(
              ...
              // UI untuk mendapatkan, memilih, dan menampilkan video dari kamera atau galeri
              SizedBox(
                height: Get.height / 2.32,
                width: Get.width * 0.7,
                child: Obx(() {
